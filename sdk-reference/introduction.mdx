...
If you are not using Unity to build your app, you can still query limited information from the ManageXR Admin App (the device serial number) using our Android SDK.
