...
The ManageXR CLI is a useful tool to automate the process of uploading applications to ManageXR. You can use the CLI in your CI/CD pipeline to upload new app versions to your ManageXR organization and even publish the versions to named [release channels](https://help.managexr.com/en/articles/5518816-release-channels).
