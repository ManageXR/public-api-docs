...
If you're making a custom homescreen, the `SceneLoader` class provides an easy to use API to load mxrus files at runtime. The environment in the mxrus file can then be loaded and shown in your application as a Unity Scene. When shown, the scene gets instantiated in the Unity scene hierarchy which allows you to access and modify its GameObjects to further drive custom behaviour. 
