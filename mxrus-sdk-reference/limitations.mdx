...
* Terrain
* AudioSource
* UI canvas and build-in UI elements
* TextMeshPro
...
|-|-|-|-|  
|`UnsupportedShader`|No|You're using a custom shader that's not supported. It may or may not run as expected. It is advised you test your environment on a small number of devices before deploying them at scale.|Use a URP shader if possible|
